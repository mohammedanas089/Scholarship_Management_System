<%@ Page Title="" Language="C#" MasterPageFile="~/usermaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="renewal.aspx.cs" Inherits="renewal" EnableEventValidation="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       Current course :
                ...
                <tr>
                    <td colspan="2" class="auto-style25">Fee balance :
                ...
                <tr>
                    <td colspan="2" class="auto-style25">SSLC :
                        <asp:Label ID="lblsslc" runat="server"></asp:Label>
                    </td>
                    <td>PU :
    ...
    margin-top:50px;">
        ...
        <div class="freshform">
            ...
            <h1>Scholarship Application Form-RENEWAL</h1>
            ...
            <asp:Panel ID="Panel3" runat="server">
                <table bgcolor="#FFCDCA" class="style1">
                    <tr>
                        ...
                        <td>Please Enter a valid E-mail ID.</td>
                    </tr>
                </table>
            </asp:Panel>
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="pu" value="no" onclick="validate2(1)" /> No</td>
                        <td id="pu">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <div class="auto-style8">
                ...
                <em><span class="auto-style44">We will send you a One Time Password on your E-mail
                    <br />
                </span><span class="auto-style12">
                <br />
                </span></em>
                <br />
                <asp:TextBox ID="TextBox8" runat="server" CssClass="otp"></asp:TextBox>
                <br />
                <br />
        ...
        <div class="auto-style8" style="vertical-align: middle">
            <span class="auto-style13" runat="server" id="v"><strong style="vertical-align: middle">Verified!!!</strong></span><img runat="server" id="tick" src="img/check.png" class="auto-style43" />
        </div>
        <br />
        ...
        <div class="auto-style8">
                ...
                <asp:Button ID="Button1" runat="server" Text="Submit" OnClick="Button1_Click" Height="26px" Width="104px" />
